...
public interface IActivity
{
    ...
    [JsonIgnore] Variables TransientOutput { get; }
    ...
    ///     Executes activity
    /// </summary>
    ValueTask<ActivityExecutionResult> ExecuteAsync(WorkflowExecutionContext context,
        CancellationToken cancellationToken = default);

    /// <summary>
    ///     Pauses activity
    /// </summary>
    ValueTask<ActivityExecutionResult> PauseAsync(WorkflowExecutionContext context,
        CancellationToken cancellationToken = default);

    /// <summary>
    ///     Resumes activity
    /// </summary>
    ValueTask<ActivityExecutionResult> ResumeAsync(WorkflowExecutionContext context,
        CancellationToken cancellationToken = default);
    ...
    /// <returns></returns>
    ValueTask<ActivityExecutionResult> HaltedAsync(WorkflowExecutionContext context,
        CancellationToken cancellationToken = default);
